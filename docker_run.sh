...
IMAGE_NAME="tgi_image_jinbh"

# Pull
#docker pull ${IMAGE_NAME}

# Run
CONTAINER_NAME=tgi_jinbh
...
#EXTRA_VOLUMES=
EXTRA_VOLUMES="-v /mnt/:/mnt -v /root/:/workspace -v /sys/kernel/debug:/sys/kernel/debug -v /dev:/dev -v /tmp:/tmp -v /home/baihuiji:/home/baihuiji"
