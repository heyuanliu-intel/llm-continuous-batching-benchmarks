...
# llama2-70b
model_name_dir=/ssd/hf_models/Llama-2-70b-hf/
num_shard=8
...
data_type=("bfloat16")
bs_arr=(16 32 64 128 256 512 1024)
...
do 
    ...
    do
        ...
        do
            ...
            bash ./hf_tgi_variable_size $input_mean $output_mean $output_range $bs $dist $input_range $model_name_dir $num_shard $dtype 2>&1 | tee term_log_im${input_mean}_ir${input_range}_om${output_mean}_or${output_range}_bs${bs}_cn${num_shard}_dt_${dtype}
            idx=$idx+1
        done
    done
done
